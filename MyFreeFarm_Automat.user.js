                ...
                if (zoneNrF=="farmersmarket-8" && slot>4) {
                    ...
                    for(var a=0;a<cowbonus.length;a++){
                        if(unsafeWindow.cowracing.data.config.products[iProd]["xp_"+cowbonus[a]]) {
                            newrow=createElement("div",{style:"display:table-row;width:100%;"},content);
                            newdiv=createElement("div",{"style":"display:inline-block;position:relative;margin-right:3px;border:none;vertical-align:sub;width: 25px; height: 22px;background:url('"+GFX+"cowracing/CowAttribute_Symbols_50x43_mini.png') "+(-25*a) +"px 0;transform:scale(0.8);"},newrow);
